...
DATA_COLLECTOR_INTERVAL = cli_option(
...
def _FormatDataCollectors(paramsdict):
  ...
  enabled = paramsdict['enabled_data_collectors']
  interval = paramsdict['data_collector_interval']
...
commands = {
  ...
  "modify": (
    ...
    [FORCE_OPT,
     ...
     [ENABLED_DATA_COLLECTORS_OPT, DATA_COLLECTOR_INTERVAL],
    "[opts...]",
